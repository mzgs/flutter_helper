...
class WebParser {
  ...
  Future<dom.Element?> query(String selector) async {
    var h = await parseHTML();
    return h.querySelector(selector);
  }

  Future<List<dom.Element>> queryAll(String selector) async {
    var h = await parseHTML();
    return h.querySelectorAll(selector);
  }
